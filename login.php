    ...
    <div class="min-h-screen flex items-center justify-center bg-blue-400">
        <div class="bg-white max-w-lg mx-auto p-8 md:p-12 lg:w-1/2 my-10 rounded shadow-2xl">    
          ...
          <form class="space-y-5">       
            <div>
              <label class="block mb-1 font-bold text-gray-500">MSNV</label>
              <input type="text" placeholder="SV0011" class="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500">
            </div>     
            <div>
            ...
            <input type="submit" value="Đăng nhập" class="font-bold block w-full bg-purple-600 hover:bg-purple-700 p-4 rounded text-white transition duration-300">   
          </form>   
          <div class="max-w-lg mx-auto text-center mt-12 mb-6">
            <a href="#" class="font-bold text-gray-600 hover:underline">Quên mật khẩu?</a>
            <p class="text-gray-700 ">Bạn chưa có tài khoản? <a href="./signup.php" class="font-bold text-gray-600 hover:underline">Đăng ký</a>.</p>
        </div>  
        </div>
      </div>
